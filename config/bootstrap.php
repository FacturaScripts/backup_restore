...
require 'plugins/backup_restore/vendor/autoload.php';
...
// build providers
$filesystems = new Filesystems\FilesystemProvider(Config::fromPhpFile('plugins/backup_restore/config/storage.php'));
$filesystems->add(new Filesystems\LocalFilesystem);
$databases = new Databases\DatabaseProvider(Config::fromPhpFile('plugins/backup_restore/config/database.php'));
